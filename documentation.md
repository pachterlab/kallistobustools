...
```
This will create the file `transcripts_to_genes.txt`. It is always a good idea to inspect the files you generate in this way. We provide a few examples of how they could look like below:
